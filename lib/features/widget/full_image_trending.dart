...
class FullImageTrending extends StatefulWidget {
  const FullImageTrending({super.key});

  @override
  State<FullImageTrending> createState() => _FullImageTrendingState();
}

class _FullImageTrendingState extends State<FullImageTrending> {
  int _imgSwapIndex = 0;
